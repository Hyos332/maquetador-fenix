...
class LocalAiReviewer:
    ...
    def _build_prompt(self, article: Article, html_path: Path, existing_warnings: list[str]) -> str:
        ...
        return (
            ...
            "Criterios MLS obligatorios: "
            "1) El orden del contenido debe respetar el DOCX: título/caption de figura, subtítulo si existe, imagen o cuadrícula, nota y texto posterior. "
            "2) Si ves una figura compuesta, no propongas separarla si aparece como cuadrícula; solo avisa si la nota queda antes de la imagen o si el texto explicativo queda mezclado dentro de la figura. "
            "3) No sugieras cambiar DOI, fechas, autores, institución ni ORCID si no hay evidencia clara en los datos. "
            "4) Para resúmenes largos, reduce palabras pequeñas o redundancias, pero conserva objetivo, método, resultados y conclusión. "
            "Ejemplos de buenas sugerencias: "
            "'La nota de Figura 2 parece quedar después de la cuadrícula, correcto; no requiere cambio.' no debe incluirse porque no es accionable. "
            "'Revisar Figura 3: la nota aparece antes de la imagen compuesta.' sí es accionable. "
            "'Resumen: proponer versión de 250 palabras sin cambiar intención.' sí es accionable si supera el límite. "
